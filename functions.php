...
function bsktv_customize($wp_customize){$wp_customize->add_section('bsktv_home',array('title'=>'BSKTV 首頁設定','priority'=>30));$wp_customize->add_setting('bsktv_hero_title',array('default'=>'探索台灣商務 KTV 與酒店資訊','sanitize_callback'=>'sanitize_text_field'));$wp_customize->add_control('bsktv_hero_title',array('label'=>'首頁主標題','section'=>'bsktv_home','type'=>'text'));$wp_customize->add_setting('bsktv_hero_text',array('default'=>'查找店家、消費方式、城市與特色，快速掌握店家資訊。','sanitize_callback'=>'sanitize_textarea_field'));$wp_customize->add_control('bsktv_hero_text',array('label'=>'首頁說明','section'=>'bsktv_home','type'=>'textarea'));$wp_customize->add_setting('bsktv_line_url',array('default'=>'','sanitize_callback'=>'esc_url_raw'));$wp_customize->add_control('bsktv_line_url',array('label'=>'LINE 連結','description'=>'全站店家頁統一使用此 LINE 連結。前台按鈕文字固定顯示「LINE」。','section'=>'bsktv_home','type'=>'url'));}
