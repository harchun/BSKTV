...
function bsktv_front_store_query($q){$q->set('post_type','post');$q->set('post_status','publish');$q->set('meta_query',array('relation'=>'OR',array('key'=>'bsktv_status','compare'=>'NOT EXISTS'),array('key'=>'bsktv_status','value'=>'active','compare'=>'=')));}
